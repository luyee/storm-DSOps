...
import Aggregate.AggregateTupleWindow;
...
public class AggregateTupleBolt implements IRichBolt {

	private static final long serialVersionUID = -2918800814680639790L;

	OutputCollector collector;

	AggregateTupleWindow window;
	...
	public void prepare(@SuppressWarnings("rawtypes") Map stormConf,
		...
		window = new AggregateTupleWindow(functions, 5, 2);
	}
	...
	public void execute(Tuple input) {
		...
		boolean emit = window.processTuple(input, result);
		collector.ack(input);
